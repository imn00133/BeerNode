...
class Scrap(models.Model):
    ...
    sweet = models.FloatField(null=True, validators=[MinValueValidator(0), MaxValueValidator(5)])
    sour = models.FloatField(null=True, validators=[MinValueValidator(0), MaxValueValidator(5)])
    bitter = models.FloatField(null=True, validators=[MinValueValidator(0), MaxValueValidator(5)])
    hoppy = models.FloatField(null=True, validators=[MinValueValidator(0), MaxValueValidator(5)])
    fruity = models.FloatField(null=True, validators=[MinValueValidator(0), MaxValueValidator(5)])
    malty = models.FloatField(null=True, validators=[MinValueValidator(0), MaxValueValidator(5)])
