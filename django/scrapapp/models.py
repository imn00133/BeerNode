...
class Scrap(models.Model):
    ...
    sweet = models.IntegerField(null=True, validators=[MinValueValidator(0), MaxValueValidator(5)])
    sour = models.IntegerField(null=True, validators=[MinValueValidator(0), MaxValueValidator(5)])
    bitter = models.IntegerField(null=True, validators=[MinValueValidator(0), MaxValueValidator(5)])
    hoppy = models.IntegerField(null=True, validators=[MinValueValidator(0), MaxValueValidator(5)])
    fruity = models.IntegerField(null=True, validators=[MinValueValidator(0), MaxValueValidator(5)])
    malty = models.IntegerField(null=True, validators=[MinValueValidator(0), MaxValueValidator(5)])
